...
public class MapReader {
	...
	public void process() {
		try {
			...
			// FileHandle file =
			// Gdx.files.internal("../core/assets/maps/world.xml");
	...
	private Train processTrain(Element e) {
		...
		if (type.equals("BigPassenger")) {
			return new BigPassengerTrain(l, s, dir, name, 80);
		} else if (type.equals("SmallPassenger")) {
			return new SmallPassengerTrain(l, s, dir, name, 10);
		} else if (type.equals("SmallCargo")) {
			return new SmallCargoTrain(l, s, dir, name, 10, 200);
		} else if (type.equals("BigCargo")) {
			return new LargeCargoTrain(l, s, dir, name, 80, 1000);
		} else {
			return new Train(l, s, dir, name, 10);
		}
	}
